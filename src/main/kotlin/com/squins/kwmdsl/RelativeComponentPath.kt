 ...
 *
 * @param basePath the base path (that is, the path of the referencing component). This must contain an element. The last path part does not actually have to contain the ID of the referencing component, as it is not used. An empty string is fine.
 * @param pathToRelativize the path for which to get the relative path to, starting from [basePath]. This must contain an element.
 * @param separator the separator to use between the path parts.
