 ...
 */
interface IRootMarkup : IKotlinWicketMarkupResourceStreamProvider {
    /**
     ...
     *
     * This is output for the no-variant and the variant markups if they are not compatible, so the user can easily determine where the hierarchies do not match.
     *
