            ...
            PrintWriter(fileWriter).use { printWriter ->
                with(printWriter) {
                    ...
                    fun attributesDeclaration() {
                        println("    vararg attributes: Pair<String, String>,")
                    }
                    ...
                    voidHtmlElements.forEach { elementName ->
                        ...
                        attributesDeclaration()
                        println(") =")
                        println("    voidElement(\"$elementName\", arrayOf(\"wicket:id\" to wicketId, *attributes))")
                        println()
                    ...
                    nonVoidHtmlElements.forEach { elementName ->
                        ...
                        blockDeclaration()
                        println(") =")
                        println("    element(\"$elementName\", arrayOf(\"wicket:id\" to wicketId, *attributes), block)")
                        println()
                        supplierFunctionElementDocStart(elementName)
                        supplierFacadeDoc()
                        propertySupplierDoc()
            ...
            PrintWriter(fileWriter).use { printWriter ->
                with(printWriter) {
                    ...
                    classElements.forEach { elementName ->
                        ...
                        blockDeclaration()
                        println(") =")
                        println("    element(\"$elementName\", arrayOf(\"class\" to cssClasses), block)")
                        println()
                        println()
                        println()
                    }
